...
return {
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- WARN: Mason must be loaded before its dependents so we need to set it up here.
    ...
    -- NOTE: This function gets run when opening a file an LSP attaches to the current buffer.
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: This is where a variable was first declared, or where a function is defined, etc.
          ...
          -- NOTE: Similar to document symbols, except searches over your whole project.
          ...
          -- NOTE: See `:help CursorHold` for information about when this is executed
      ...
      -- Diagnostic Config
      -- NOTE: See `:help vim.diagnostic.Opts` for more information.
      ...
      -- For example, we create new capabilities with `blink.cmp`, and then broadcast that to the servers.
